...
export type NavigationItem = { href: string; label: string; area: "dashboard" | "financial" | "dre" | "analytics_commercial" | "configuration" | "profiles"; roles: readonly UserRole[] };
...
export const MANAGEMENT_NAVIGATION: readonly NavigationItem[] = [
  ...
  { href: "/administracao", label: "Administração", area: "configuration", roles: ["ADMIN"] },
  { href: "/usuarios", label: "Usuários", area: "profiles", roles: ["ADMIN"] },
