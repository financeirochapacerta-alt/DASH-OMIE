import { DataTable, EmptyState, MetricGrid, PageHeading } from "@/components/management/dashboard-ui"; import { GlobalFilters } from "@/components/management/global-filters"; import { requireManagementAccess } from "@/features/management/access"; import { getManagementPageData } from "@/features/management/data";
export default async function DrePage(){
  ...
  return <>
    <PageHeading eyebrow="DRE Gerencial" title="Resultado com rastreabilidade" description="Tipo, grupo, conta e categoria por vencimento"><GlobalFilters /></PageHeading>
    ...
    <DataTable title="Hierarquia Tipo → Grupo → Conta → Categoria" columns={["Tipo","Grupo","Conta","Categoria","Origem","Valor"]} rows={data.rows}/>
  </>;
}
